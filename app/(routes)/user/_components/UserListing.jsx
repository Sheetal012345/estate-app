...
import { useUser } from "@clerk/nextjs"; // ✅ FIX
  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
            ...
            <Button size='sm'className='w-full  bg-blue-600 hover:bg-blue-700 text-white'>Edit</Button>
            </Link>
            <Button size='sm' variant='destructive' className='w-full  bg-blue-600 hover:bg-blue-700 text-white'>
                <Trash/>
