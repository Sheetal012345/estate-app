...
;
// ✅ import ONLY ONCE
const LeafletMapSection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(async ()=>{}, {
    loadableGenerated: {
        modules: [
...
function ListingMapView({ type }) {
    ...
    const handleSearchClick = async ()=>{
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("listing").select(`*, listingImages(url, listing_id)`).eq("active", true).gte("bedroom", bedCount).gte("bathroom", bathCount).gte("parking", parkingCount).ilike("address", `%${searchTerm}%`).order("id", {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae6f69ba._.js.map