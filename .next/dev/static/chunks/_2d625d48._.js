...
function ListingMapView({ type }) {
    ...
    const getLatestListing = async ()=>{
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("listing").select(`*, listingImages(url, listing_id)`).eq("active", true).order("id", {
            ascending: false
        });
